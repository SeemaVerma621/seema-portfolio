...
Hands-on experience in React.js through building dashboards, multi-page applications, and REST API integrations using modern React ecosystem.
          ...
          <div className="flex gap-4 mt-4">
            <a href="#projects" className="bg-primary px-6 py-3 rounded-lg text-white font-medium hover:opacity-90 transition">
              View My Work
            </a>

            <a href="#contact" className="border border-primary text-primary px-6 py-3 rounded-lg font-medium hover:bg-primary hover:text-white transition">
              Contact Me
            </a>
          </div>
        </div>
